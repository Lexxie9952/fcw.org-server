...
void spaceship_calc_derived(struct player_spaceship *ship)
{
  ...
  */
  ...
  ship->travel_time = (ship->mass * (game.server.spaceship_travel_time / 100.0))
...
void handle_spaceship_launch(struct player *pplayer)
{
  ...
  notify_player(NULL, NULL, E_SPACESHIP, ftc_server,
                _("[`events/spaceship`]<br>[`spaceship`] The %s have launched a spaceship!  "
...
{
  notify_player(NULL, NULL, E_SPACESHIP, ftc_server,
                _("[`events/spacelanding`]<br>[`spaceship`] The %s spaceship has arrived at Alpha Centauri."),
