...
#define SPECENUM_VALUE119 EFT_UNIT_RECOVER_PCT
#define SPECENUM_VALUE119NAME "Unit_Recover_Pct"
/* Yay, finally programmatic ruleset conditions for happy upkeep! 
   (use negative value to decrease unhappiness.) */
#define SPECENUM_VALUE120 EFT_UNIT_UNHAPPY_COST
#define SPECENUM_VALUE120NAME "Unit_Unhappy_Cost"
/* uk_happy "discount" for non-aggressively deployed field units */
#define SPECENUM_VALUE121 EFT_PEACEFUL_FIELDUNIT_BONUS
#define SPECENUM_VALUE121NAME "Peaceful_Field_Unit_Bonus"
#define SPECENUM_VALUE122 EFT_FORTIFY_DEFENSE_BONUS
#define SPECENUM_VALUE122NAME "Fortify_Defense_Bonus"
...
#define SPECENUM_VALUE124 EFT_UNIT_WORK_FRAG_BONUS
#define SPECENUM_VALUE124NAME "Unit_Work_Frag_Bonus"
#define SPECENUM_VALUE125 EFT_UNIT_WORK_PCT
#define SPECENUM_VALUE125NAME "Unit_Work_Pct"
/* adds val to the hard-coded 1:1 conversion of shields to gold */
#define SPECENUM_VALUE126 EFT_COINAGE_BONUS_PM
#define SPECENUM_VALUE126NAME "Coinage_Bonus_Pm"
/* bonus/penalty to gold acquired from selling a building */
#define SPECENUM_VALUE127 EFT_IMPROVEMENT_SALE_PCT
#define SPECENUM_VALUE127NAME "Improvement_Sale_Pct"
/* suppresses game.server.hangry based on reqs from game state */
#define SPECENUM_VALUE128 EFT_GULAG
#define SPECENUM_VALUE128NAME "Gulag"
/* Pct modifier for chance to escape stack */
#define SPECENUM_VALUE129 EFT_STACK_ESCAPE_PCT
#define SPECENUM_VALUE129NAME "Stack_Escape_Pct"
/* Multiplied over and after Building_Build_Cost_Pct is (possibly) applied */
#define SPECENUM_VALUE130 EFT_IMPR_BUILD_COST_PM
#define SPECENUM_VALUE130NAME "Building_Build_Cost_Pm"
/* Allows target to get bonus resistance in cases where req ranges can't modify */
#define SPECENUM_VALUE131 EFT_ACTION_RESIST_PCT
#define SPECENUM_VALUE131NAME "Action_Resist_Pct"
