...
var ACTION_SPY_STEAL_TECH = 12;
var ACTION_SPY_STEAL_TECH_ESC = 13;
var ACTION_SPY_TARGETED_STEAL_TECH = 14;
var ACTION_SPY_TARGETED_STEAL_TECH_ESC = 15;
var ACTION_SPY_INCITE_CITY = 16;
var ACTION_SPY_INCITE_CITY_ESC = 17;
var ACTION_TRADE_ROUTE = 18;
var ACTION_MARKETPLACE = 19;
var ACTION_HELP_WONDER = 20;
var ACTION_SPY_BRIBE_UNIT = 21;
var ACTION_SPY_SABOTAGE_UNIT = 22;
var ACTION_SPY_SABOTAGE_UNIT_ESC = 23;
var ACTION_CAPTURE_UNITS = 24;
var ACTION_FOUND_CITY = 25;
var ACTION_JOIN_CITY = 26;
var ACTION_STEAL_MAPS = 27;
var ACTION_STEAL_MAPS_ESC = 28;
var ACTION_BOMBARD = 29;
var ACTION_SPY_NUKE = 30;
var ACTION_SPY_NUKE_ESC = 31;
var ACTION_NUKE = 32;
var ACTION_NUKE_CITY = 33;
var ACTION_NUKE_UNITS = 34;
var ACTION_DESTROY_CITY = 35;
var ACTION_EXPEL_UNIT = 36;
var ACTION_RECYCLE_UNIT = 37;
var ACTION_DISBAND_UNIT = 38;
var ACTION_HOME_CITY = 39;
var ACTION_UPGRADE_UNIT = 40;
var ACTION_PARADROP = 41;
var ACTION_AIRLIFT = 42;
var ACTION_ATTACK = 43;
var ACTION_SUICIDE_ATTACK = 44;
var ACTION_STRIKE_BUILDING = 45;
var ACTION_CONQUER_CITY = 46;
var ACTION_CONQUER_CITY2 = 47;
var ACTION_HEAL_UNIT = 48;
var ACTION_TRANSFORM_TERRAIN = 49;
var ACTION_CULTIVATE = 50;
var ACTION_PLANT = 51;
var ACTION_PILLAGE = 52;
var ACTION_FORTIFY = 53;
var ACTION_ROAD = 54;
var ACTION_CONVERT = 55;
var ACTION_BASE = 56;
var ACTION_MINE = 57;
var ACTION_IRRIGATE = 58;
var ACTION_TRANSPORT_ALIGHT = 59;
var ACTION_TRANSPORT_UNLOAD = 60;
var ACTION_TRANSPORT_DISEMBARK1 = 61;
var ACTION_TRANSPORT_DISEMBARK2 = 62;
var ACTION_TRANSPORT_BOARD = 63;
var ACTION_TRANSPORT_EMBARK = 64;
var ACTION_CLEAN_POLLUTION = 65;
var ACTION_CLEAN_FALLOUT = 66;
var ACTION_SPY_ATTACK = 67;
var ACTION_COUNT = 68;
