  ...
  for (var i = 0; i < punits.length; i++) {
    ...
    unit_info_html += "<div id='unit_info_div' class='" + (active ? "current_focus_unit'" : "' style='background-color:rgba(15, 0, 0, 0.55);'")
	   ...
	   + " style='margin-right:1px; background: transparent url(" 
           ...
           + "px;  background-size: 64px 48px; width:64px;height:48px;'"   // force everything to 64x48 including oversize units (Lexxie)
//         + "px;  width: " + sprite['width'] + "px;height: " + sprite['height'] + "px;'"   previous line
  ...
  if (current_focus.length == 1) {
    ...
    if (current_focus[0]['owner'] == client.conn.playing.playerno) {
      unit_info_html += "<span style='color:white'>Moves:<span style='color:khaki;font-size:110%;'><b>" + move_points_text(aunit['movesleft']) + "</b></span></span> ";
