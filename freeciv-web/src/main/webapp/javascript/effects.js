...
const EFT_UNIT_UNHAPPY_COST = 119;
const EFT_PEACEFUL_FIELDUNIT_BONUS = 120;
const EFT_FORTIFY_DEFENSE_BONUS = 121;
const EFT_UNIT_SHIELD_VALUE_PCT = 122;
const EFT_UNIT_WORK_FRAG_BONUS = 123;
const EFT_UNIT_WORK_PCT = 124;
const EFT_COINAGE_BONUS_PM = 125;
const EFT_IMPROVEMENT_SALE_PCT = 126;
const EFT_GULAG = 127;
const EFT_STACK_ESCAPE_PCT = 128;
const EFT_IMPR_BUILD_COST_PM = 129;
const EFT_ACTION_RESIST_PCT = 130;
//___________________
const EFT_LAST = 131;
