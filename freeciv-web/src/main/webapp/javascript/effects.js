...
const EFT_NUKE_SURVIVAL_PCT = 144
const EFT_RAZE_BUILDING_PCT = 145
const EFT_DEFENDER_COMBAT_ROUNDS = 146
const EFT_UNIT_MIN_SPEED = 147
const EFT_PASSENGER_MOVE_COST_BP = 148
const EFT_GULAG_LOST_INCOME_PCT = 149
const EFT_LAST = 150
