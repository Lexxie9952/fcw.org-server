...
<div style="font-size:100%">
  ...
  &bull; In-game threats about in-game consequences are normal. Out-of-game threats about sedition, drama, exposure, public boycott, reputation degradation, or rebellion; unless a GM/Admin/Player meets your demands, is not only <b>A</b>SS<b>HATS</b>, but <u>unconstitutional</u>. Go to the GM or site admin <i>privately </i>to handle situations. If that's the same person or not resolved, abide by (9) below so the site can make bureaucratic formal corrections to its processes. If you use ultimatum, threats, or leverage 'negative publicity actions', you automatically lose your case, any chance of appeal, and face punitive consequences including possible banning.<br>
  &bull; ASSHATing that affects game outcome or integrity may be punished or corrected by the GM. <br>
  &bull; Respect other players' mental health. In-game threats, manipulation, psy-ops, and mindwarps are legal but must carefully and completely <b>a)</b> <u>be fictional</u>: role-played between virtual leaders <b>b)</b> <u>politely respect</u> the human identity behind the virtual player, <b>c)</b>, <u>avoid escalatation</u> of emotional communication. &#x26a0; Conflicts happen in war games. When dialog worsens, first <u>reduce communication</u> to simple yes/no questions, then <u>go silent</u>. <br>
  ...
  any content in the complaint either directly, indirectly, or implicitly, impugns, accuses, or maligns FCW, its players, admins, GMs, or moderators; or debates/challenges the rules of FCW or their interpretation.<br><br>
