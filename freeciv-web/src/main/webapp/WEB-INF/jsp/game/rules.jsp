...
<div class="container">
  ...
  <div style="font-size:85%">
    1. Be polite: This is rule #1 for a reason. We take it very seriously. It covers a lot but is easy enough to follow: be nice. You cannot politely harrass, threaten, DOX, copy-paste someone's content off-site without permission, violate privacy, etc. If you're not sure, ask.<br>
    2.1. No multi-accounts.<br> 
    2.2. Browser hacking, console hacking, packet hacking, server hacking, and any other form of hacking is 100% considered as cheating.<br>
    2.3. Information, actions, or access not commonly available through normal use of the game's interface is competitive inequality. At Freeciv-web this is considered cheating without exception.<br>
    3. Keep in-game conflicts in-the-game. <br>
    3.1 Remember, your enemy may be your ally in a future game. <br>
    3.2. You may role play impolite hostility in-game if you represent yourself as your country's fictional leader and do the same for the person you are speaking about. e.g. "The Oldenburgian nation are lying warmongers and cannot be trusted" is acceptable. <br>
    4. No abuse, spam, harrassment. This includes but is not limited to, using another person or "bot" as the agent for violating any site rules.<br>
    4.1 Offsite links are almost always spam. Within reason, preserve the game entertainment ambience by keeping in-game chat relative to the in-game play of your player-nation.<br>
    4.2 Dominating a community discussion in Discord by simply posting many more messages than anyone is also bad form, let others give their views. <br>
    ...
    7. All constructive ideas and contributions are welcome. Politicking against the site or its members can be freely done in locations other than FCW.<br>
    ...
    11a. General sharing permission is already granted be default, for game experiences available from the perspective of the nation you play in any game, and any message you make that does not interact with or imply or help infer, another user's private content.<br>
  </div>
    ...
    15.4c A player, or group of players make a statement about how the game should end, that goes uncontested for 72 hours (or two turns, whichever is longer)<br>
    ...
    14. Victory conditions are set by the Gamemaster (GM) at the start. When they are met, the game ends. Unless the GM specified against at the outset, scores are published <br>
    ...
    16. Allow players to take their turns in peace. This includes respecting requests not to RTS. RTS is to be expected at turn change, just prior to turn change, and at unitwaittime before and after turn change. All other times, RTS is not allowed if a player requests to take their turn in peace.<br>
    16.1 No camping. A player should not be online for most the day. Remaining online all day is unfair to everyone else. <br>
    16.1a Rule 16.1 is relaxed after turn 100 in games or upon discovery of Flight (whichever comes sooner), until a fix for large nations is in place. Gamemaster discretion is final, if players are in dispute.<br>
    17. Regarding multiple players in the same household or sharing the same device:  The Gamemaster for a particular game can approve such cases if asked privately in advance of you joining the game; otherwise it is forbidden. Gamemaster decision will be final, and GM may make special rules for allowing the case like making all players aware of it, or forbidding alliance between the two players. <br>
    </div>
