...
<br>
    ...
    2. To improve our site and user experiences - Information and feedback supplied by users may be used to improve the site experience.<br>
    3. To send emails - PBEM games email you when it's your turn. If you subscribe, the Longturn Notification system notifies you of upcoming games.<br>
    4. Site security - Server logs may be used in conventional server security operations, identifying and preventing malicious sources.<br>
    </div>
<br>
    <div>
...
<br>
  ...
  <br>
    ...
    6. However, non-personally identifiable visitor information will not be provided to other parties for marketing or advertising, without your explicit consent.<br>
    </div>
<br>
    <div>
