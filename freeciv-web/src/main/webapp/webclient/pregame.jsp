...
<div id="pregame_page">
  <div id="pregame_options">
	<div id="pregame_buttons">
		...
		<button id="start_game_button" title="Start Game" type="button" class="button"><i class="fa fa-check-circle-o" aria-hidden="true"></i><b> Start</b></button>
		...
		<button id="pregame_settings_button" title="Game options" type="button" class="button"><i class="fa fa-cogs" aria-hidden="true"></i> Game</button>
	</div>
