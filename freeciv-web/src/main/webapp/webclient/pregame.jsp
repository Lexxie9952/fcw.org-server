...
<div id="pregame_page">
  <div id="pregame_options">
	<div id="pregame_buttons">
      ...
      <button id="start_game_button" title="Starting the game implies consent with Terms of Service" type="button" class="button"><i class="fa fa-check-circle-o" aria-hidden="true"></i><b> Start</b></button>
    </div>
  </div>
