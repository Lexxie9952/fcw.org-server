<div id="warcalc_static">
    ...
    <table id="wcbtbl" style="margin:auto; width:360; border-collapse:collapse" class="warcalc">
            <tbody>
                ...
                <tr>
                    ...
                    <td align="center"><button id="wca125" class="tiny_button"  onClick="wc_A(1.25);">&#xD7;1.25</button></td>
                    <td align="center"><button id="wca133" class="tiny_button"  onClick="wc_A(1.33);" disabled>&#xD7;1.33</button></td>
                    <td align="center"><button id="wca150" class="tiny_button"  onClick="wc_A(1.50);">&#xD7;1.5&nbsp;</button></td>
                    <td align="center"><button id="wca167" class="tiny_button"  onClick="wc_A(1.67);" disabled>-</button></td>
                    <td align="center"><button id="wca175" class="tiny_button"  onClick="wc_A(1.75);">&#xD7;1.75</button></td>
                    <td align="center"><button id="wca200" class="tiny_button"  onClick="wc_A(2.00);">&nbsp;&nbsp;&#xD7;2&nbsp;&nbsp;</button></td>
                    <td align="center"><button id="wca210" class="tiny_button"  onClick="wc_A(2.1);">&#xD7;2.1&nbsp;</button></td>
                    <td align="center"><button id="wca220" class="tiny_button"  onClick="wc_A(2.2);">&#xD7;2.2&nbsp;</button></td>
                    <td align="center"><button id="wca230" class="tiny_button"  onClick="wc_A(2.3);">&#xD7;2.3&nbsp;</button></td>
                </tr>
                <tr>
                    <th class="wcttmsg" id="wcth2" title='Defender vs. Attacker bonus appliers' style="font-size:90%">Defend&nbsp;</th>
                    <td align="center"><button id="wc125" class="tiny_button"  onClick="wc_D(1.25);">&#xD7;1.25</button></td>
                    <td align="center"><button id="wc133" class="tiny_button"  onClick="wc_D(1.33);">&#xD7;1.33</button></td>
                    <td align="center"><button id="wc150" class="tiny_button"  onClick="wc_D(1.50);">&#xD7;1.5&nbsp;</button></td>
                    <td align="center"><button id="wc167" class="tiny_button"  onClick="wc_D(1.67);">&#xD7;1.67</button></td>
                    <td align="center"><button id="wc175" class="tiny_button"  onClick="wc_D(1.75);">&#xD7;1.75</button></td>
                    <td align="center"><button id="wc200" class="tiny_button"  onClick="wc_D(2.00);">&nbsp;&nbsp;&#xD7;2&nbsp;&nbsp;</button></td>
                    <td align="center"><button id="wc210" class="tiny_button"  onClick="wc_D(2.1);">&#xD7;2.1&nbsp;</button></td>
                    <td align="center"><button id="wc220" class="tiny_button"  onClick="wc_D(2.2);">&#xD7;2.2&nbsp;</button></td>
                    <td align="center"><button id="wc230" class="tiny_button"  onClick="wc_D(2.3);">&#xD7;2.3&nbsp;</button></td>
                    <td align="center"><button id="wc300" class="tiny_button"  onClick="wc_D(3.00);">&nbsp;&nbsp;&#xD7;3&nbsp;&nbsp;</button></td>
                    <td align="center"><button id="wc400" class="tiny_button"  onClick="wc_D(4.00);">&nbsp;&nbsp;&#xD7;4&nbsp;&nbsp;</button></td>
                    <td align="center"><button id="wc500" class="tiny_button"  onClick="wc_D(5.00);">&nbsp;&nbsp;&#xD7;5&nbsp;&nbsp;</button></td>
                </tr>
            </tbody>
    </table>
    ...
    <div id = "warcalc_scroll">
        ...
        <p style="text-align:center;">
            <button id="warcalc_calc_button" class="button ui-button ui-corner-all ui-widget" title="Locally calculates odds from on-screen data" onclick="warcalc_compute();" role="button">calc</button>
            <button id="warcalc_swap_button" class="button ui-button ui-corner-all ui-widget" title="Swaps selected Attacker and Defender units" onClick="warcalc_swap_roles();" role="button">swap</button>
            <button id-"warcalc_ask_button" class="button ui-button ui-corner-all ui-widget" title="Remotely calculate bonuses and odds on server. Requires 2 selected units." onClick="warcalc_request_server();">ask</button>
