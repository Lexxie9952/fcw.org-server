<div id="game_unit_orders_default">       
  ...
  <div id="order_load" class="order_button" title="Load (L)">
  ...
  <div id="order_noorders" class="order_button" title="No Orders/Sleep (J)">
  ...
  <div id="order_cancel_orders" class="order_button" title="Cancel Orders (Shift-J)">
